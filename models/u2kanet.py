...
from .reskanet import kan_conv3x3, kagn_conv3x3, kacn_conv3x3, kaln_conv3x3, fast_kan_conv3x3
...
def u2kagnet(input_channels, num_classes, groups: int = 1, degree: int = 3, width_scale: int = 1,
    ...
    conf_fun = partial(kagn_conv3x3, degree=degree, groups=groups, dropout=dropout, l1_decay=l1_decay)
    conf_fun_first = partial(kagn_conv3x3, degree=degree, groups=1, dropout=dropout, l1_decay=l1_decay)
...
def u2kalnet(input_channels, num_classes, groups: int = 1, degree: int = 3, width_scale: int = 1,
             dropout: float = 0.0, l1_decay: float = 0.0):
    conf_fun = partial(kaln_conv3x3, degree=degree, groups=groups, dropout=dropout, l1_decay=l1_decay)
    conf_fun_first = partial(kaln_conv3x3, degree=degree, groups=1, dropout=dropout, l1_decay=l1_decay)
...
def u2kacnet(input_channels, num_classes, groups: int = 1, degree: int = 3, width_scale: int = 1,
             dropout: float = 0.0, l1_decay: float = 0.0):
    conf_fun = partial(kacn_conv3x3, degree=degree, groups=groups, dropout=dropout, l1_decay=l1_decay)
    conf_fun_first = partial(kacn_conv3x3, degree=degree, groups=1, dropout=dropout, l1_decay=l1_decay)
...
def u2kanet(input_channels, num_classes, groups: int = 1, spline_order: int = 3, grid_size: int = 5,
    ...
    conf_fun = partial(kan_conv3x3, spline_order=spline_order, groups=groups, grid_size=grid_size, dropout=dropout,
                       l1_decay=l1_decay, base_activation=base_activation, grid_range=grid_range, )
